...
//        StringBuilder buf = new StringBuilder(24);
    ...
    private static int createMachineIdentifier() {
        ...
        try {
            ...
            System.out.println("Failed to get machine identifier from network interface, using random number instead： "+t.getMessage());
            t.printStackTrace();
        }
    ...
    private static short createProcessIdentifier() {
        ...
        try {
            ...
            System.out.println("Failed to get process identifier from JMX, using random number instead: "+t.getMessage());
            t.printStackTrace();
        }
